...
export class SettingsManager {
    ...
    private getDefaultModels(): ModelConfig[] {
        return [
            { id: 'default-deepseek', modelId: 'deepseek-chat', label: 'DeepSeek-V3', baseUrl: 'https://api.deepseek.com/v1', tasks: ['code_gen', 'code_review', 'math_reasoning'], enabled: true, priority: 0 },
            { id: 'default-glm', modelId: 'glm-4', label: 'GLM-4', baseUrl: 'https://open.bigmodel.cn/api/paas/v4', tasks: ['architecture', 'agentic', 'tool_calling', 'long_context'], enabled: true, priority: 0 },
            { id: 'default-qwen', modelId: 'qwen-max', label: 'Qwen-Max', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', tasks: ['translation', 'documentation', 'tool_calling'], enabled: true, priority: 0 },
            { id: 'default-minimax', modelId: 'abab6.5-chat', label: 'MiniMax abab6.5', baseUrl: 'https://api.minimax.chat/v1', tasks: ['ui_design', 'creative', 'long_context'], enabled: true, priority: 0 },
        ];
    }
