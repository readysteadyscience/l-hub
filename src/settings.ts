...
export class SettingsManager {
    ...
    private getDefaultModels(): ModelConfig[] {
        return [
            { id: 'default-deepseek', modelId: 'deepseek-chat', label: 'DeepSeek-V3 (推荐)', baseUrl: 'https://api.deepseek.com/v1', tasks: ['code_gen', 'code_review', 'math_reasoning'], enabled: true, priority: 0 },
